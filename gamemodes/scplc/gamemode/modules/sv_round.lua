...
function GM:SLCPreround()
	...
	net.Broadcast()*/
	billboard = ents.Create ( "prop_physics" )
	billboard:SetModel ( "models/props/cs_assault/billboard.mdl" )
	billboard:SetPos( Vector( -658.719177, 750.554932, 302.377991 ) )
	billboard:SetAngles( Angle ( 1.757247, 178.431900, 0.000000 ) )
	billboard = ents.Create ( "prop_physics" )
	billboard:SetModel ( "models/props/cs_assault/billboard.mdl" )
	billboard:SetPos( Vector( 179.943756, 3088.957275, 131.181915 ) )
	billboard:SetAngles( Angle ( -0.402883, 89.574600, 0.000000 ) )
	billboard = ents.Create ( "prop_physics" )
	billboard:SetModel ( "models/props/cs_assault/billboard.mdl" )
	billboard:SetPos( Vector( -2290.217773, 6960.881348, 2474.407959 ) )
	billboard:SetAngles( Angle ( 1.007356, -1.807827, 0.000000 ) )
	billboard = ents.Create ( "prop_physics" )
	billboard:SetModel ( "models/props/cs_assault/billboard.mdl" )
	billboard:SetPos( Vector( -7114.233887, 3510.117188, 2889.418701 ) )
	billboard:SetAngles( Angle ( -0.604362, -90.571136, 0.000000 ) )
	posapc = Vector( -1294.012695, 7067.158203, 2272.031250 ) 
	angleapc = Angle ( 0.439973, 90.935776, 0.000000 ) 
	simfphys.SpawnVehicleSimple( "sim_fphys_conscriptapc", posapc, angleapc )
	wheelchair = ents.Create ( "wheelchair" )
	wheelchair:SetPos( Vector( 1475.491821, -565.470886, 64.031250 ) )
	wheelchair:SetAngles( Angle ( -0.087992, -90.399689, 0.000000 ) )
	wheelchair:Spawn()
	wheelchair = ents.Create ( "wheelchair" )
	wheelchair:SetPos( Vector( -510.824768, 3587.358887, 64.031250 ) )
	wheelchair:SetAngles( Angle ( 0.616033, 45.388462, 0.000000 ) )
	wheelchair:Spawn()
	wheelchair = ents.Create ( "wheelchair" )
	wheelchair:SetPos( Vector( -548.182312, 6317.239258, 2624.031250 ) )
	wheelchair:SetAngles( Angle ( -0.088778, 179.232483, 0.000000 ) )
	wheelchair:Spawn()
end
...
function GM:SLCPostround( winner )
	...
	TransmitSound( "round/roundend.mp3", true )
	/*net.Start( "PlaySound" )
		net.WriteUInt( 1, 1 )
